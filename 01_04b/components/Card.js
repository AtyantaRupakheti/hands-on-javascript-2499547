...
const Card = (imgData) => {
  // we will use object destructuring (allows us to take a data object and pull out only the properties we want to use and give them names)
  const {
    description,
    user: { name },
    ...
    <figure class="image">
      ...
      <figcaption class="image__caption">
        ...
        <div class="image__meta">
          ...
          <p>
            Uploaded on <time class="image__date" datetime="${createdDate}">${getDate()}</time>.
          </p>
          <p>
